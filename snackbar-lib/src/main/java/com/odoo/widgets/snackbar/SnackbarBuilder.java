...
import com.odoo.odoosnackbarlib.R;
import com.odoo.widgets.snackbar.listeners.ActionClickListener;
import com.odoo.widgets.snackbar.listeners.EventListener;
import com.odoo.widgets.snackbar.listeners.SwipeDismissTouchListener;

public class SnackbarBuilder extends RelativeLayout {

	public enum SnackbarDuration {
		LENGTH_SHORT(2000), LENGTH_LONG(3500), NONE(0);
	...
	public static SnackbarBuilder with(Context context) {
		return new SnackbarBuilder(context);
	}

	public SnackbarBuilder type(SnackbarType type) {
		mType = type;
		return this;
	}
	...
	public SnackbarBuilder textColor(int textColor) {
		mTextColor = textColor;
		return this;
	}

	public SnackbarBuilder actionLabel(CharSequence actionButtonLabel) {
		mActionLabel = actionButtonLabel;
		return this;
	}

	public SnackbarBuilder actionColor(int actionColor) {
		mActionColor = actionColor;
		return this;
	}

	public SnackbarBuilder dismissOnActionClicked(boolean shouldDismiss) {
		mShouldDismissOnActionClicked = shouldDismiss;
		return this;
	}

	public SnackbarBuilder actionListener(ActionClickListener listener) {
		mActionClickListener = listener;
		return this;
	}

	public SnackbarBuilder eventListener(EventListener listener) {
		mEventListener = listener;
		return this;
	}

	public SnackbarBuilder animation(boolean withAnimation) {
		mAnimated = withAnimation;
		return this;
	}

	public SnackbarBuilder swipeToDismiss(boolean canSwipeToDismiss) {
	...
	private void init(Activity parent) {
		...
		TextView snackbarText = (TextView) layout
		...
		TextView snackbarAction = (TextView) layout
			...
			snackbarAction.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View view) {
					if (mActionClickListener != null) {
						mActionClickListener.onActionClicked(bar);
					}
	...
	public void show(Activity targetActivity) {
		...
		ViewGroup root = (ViewGroup) targetActivity
	...
	public void dismiss() {
		...
		final Animation slideOut = AnimationUtils.loadAnimation(getContext(),
				R.anim.snackbar_out);
	...
	public long getDuration() {
		return mCustomDuration == -1 ? mDuration.getDuration()
				: mCustomDuration;
	}
